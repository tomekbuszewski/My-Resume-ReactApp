      ...
      <div className="columns">
        <div className="column">
          <div className="field is-horizontal">
            ...
            <div className="field-body"><div className="field"><input disabled={this.props.editable} onChange={(e) => {!this.props.editable ? this.changeValue(e) : null; }} type="text" className="input C-Input--small" value={this.state.value} /></div></div>
          </div>
        </div>
